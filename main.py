"""
    ...
    @Description : 
        ...
        Don't be stupid and use linux distriputions where you can do a banch more usefull 
        stuff and literally free your computer from the chains of microsoft. Those are for
        people who respect themselves ,wich we and you are cleary dont. Simply use our great
        with no bugs at all open source code to do the job. <3 !

        -Now that we laughed(not) with my houmor. This is an open-source code 
        ...
        We did it mostly for practice and test our knowlegde. Hope you like it.
